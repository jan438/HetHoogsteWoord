...
function clearclasses() {
	...
	$("#c4s1digit1").removeClass('box-shadow');
	$("#c4s1digit2").removeClass('box-shadow');
	$("#c4s1digit3").removeClass('box-shadow');
	$("#c4s1digit4").removeClass('box-shadow');
	$("#c4s2digit1").removeClass('box-shadow');
	$("#c4s2digit2").removeClass('box-shadow');
	$("#c4s2digit3").removeClass('box-shadow');
	$("#c4s2digit4").removeClass('box-shadow');
	$("#c4s3digit1").removeClass('box-shadow');
	$("#c4s3digit2").removeClass('box-shadow');
	$("#c4s3digit3").removeClass('box-shadow');
	$("#c4s3digit4").removeClass('box-shadow');
	$("#c4s4digit1").removeClass('box-shadow');
	$("#c4s4digit2").removeClass('box-shadow');
	$("#c4s4digit3").removeClass('box-shadow');
	$("#c4s4digit4").removeClass('box-shadow');
	$("#c4s5digit1").removeClass('box-shadow');
	$("#c4s5digit2").removeClass('box-shadow');
	$("#c4s5digit3").removeClass('box-shadow');
	$("#c4s5digit4").removeClass('box-shadow');
	$("#c4s6digit1").removeClass('box-shadow');
	$("#c4s6digit2").removeClass('box-shadow');
	$("#c4s6digit3").removeClass('box-shadow');
	$("#c4s6digit4").removeClass('box-shadow');
}
